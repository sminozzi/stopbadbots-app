...
echo '{label: "Hosting / Datacenter", data: '.$stopbadbots_results10[0]['hosting'].', color: "#8e44ad" },';
...
if (!empty($checkversion)) {
    ...
    echo '{label: "False Google & Microsoft", data: '.$stopbadbots_results10[0]['false_se'].', color: "#666666" },';
    ...
    echo '{label: "Disabled-False Google/MSN", data: '.$stopbadbots_results10[0]['false_se'].', color: "#666666" },';
