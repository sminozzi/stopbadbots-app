 ...
 */ 
 ...
 //var_dump($stopbadbots_results10);
//die();



if (
    !isset($stopbadbots_results10) ||
    !is_array($stopbadbots_results10) ||
    !isset($stopbadbots_results10[0]) ||
    !is_array($stopbadbots_results10[0]) ||
    (
        empty($stopbadbots_results10[0]['Bots']) &&
        empty($stopbadbots_results10[0]['Humans'])
    )
) {
    echo '<div style="width:400px;height:280px;margin:0px 0 auto; display:flex; align-items:center; justify-content:center; color:#777;">';
