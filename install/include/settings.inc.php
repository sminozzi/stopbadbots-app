<?php
    ...
    define('EI_MODE', 'debug'); //production
    ...
    //define('EI_CONFIG_FILE_DIRECTORY', '');
     define('EI_CONFIG_FILE_DIRECTORY', '/stopbadbots/common/'); //Bill
  ...
  //  define('EI_SQL_DUMP_FILE_UN_INSTALL', 'sql_dump/un-install.sql');
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'Stop Bad Bots');
    // *** version number of your application 
    define('EI_APPLICATION_VERSION', 'v2.0');
