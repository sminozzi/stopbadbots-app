...
################################################################################
	...
	$check_key = isset($_POST['check_key']) ? prepare_input(trim($_POST['check_key'])) : '';
	$database_host = isset($_POST['db_host']) ? prepare_input(trim($_POST['db_host'])) : '';
	$database_name = isset($_POST['db_name']) ? prepare_input(trim($_POST['db_name'])): '';
	$database_username = isset($_POST['db_username']) ? prepare_input(trim($_POST['db_username'])) : '';
	$database_password = isset($_POST['db_password']) ? prepare_input(trim($_POST['db_password'])) : '';
