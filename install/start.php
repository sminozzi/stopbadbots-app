						...
						<tbody>
							<tr>
								...
								<big>
									...
									if (file_exists($doc_root . '/' . EI_CONFIG_FILE_DIRECTORY . EI_CONFIG_FILE_NAME)) { ?>
										<h2>The file config.php exists ! </h2> <br><br>
										Please remove it and try again. <br>
										Here is the path: <br>
									<?php
										echo EI_CONFIG_FILE_DIRECTORY . EI_CONFIG_FILE_NAME;
									} else { ?>
										This App will check your server and create a database config file.
										<br>
										Just Follow the instructons and click the orange button.
									<?php	} ?>
								</big>
							</tr>
							<!--
					...
					-->
							...
							<tr>
								<td>
									<?php
									if (!file_exists($doc_root . '/' . EI_CONFIG_FILE_DIRECTORY . EI_CONFIG_FILE_NAME)) {
										echo '<input type="submit" class="form_button" name="btnSubmit" id="button_start" title="click_to_start_installation" value="Start" />';
									} ?>
								</td>
							</tr>
						</tbody>
