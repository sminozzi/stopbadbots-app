...
// -------------------------------------------------
if ($task == 'send') {
	$database_host		= isset($_POST['database_host']) ? prepare_input(trim($_POST['database_host'])) : 'localhost';
	$database_name 		= isset($_POST['database_name']) ? prepare_input(trim($_POST['database_name'])) : '';
	$database_username	= isset($_POST['database_username']) ? prepare_input(trim($_POST['database_username'])) : '';
	$database_password	= isset($_POST['database_password']) ? prepare_input(trim($_POST['database_password'])) : '';
	$database_prefix	= isset($_POST['database_prefix']) ? prepare_input(trim($_POST['database_prefix'])) : '';
	$install_type		= isset($_POST['install_type']) ? prepare_input(trim($_POST['install_type'])) : 'create';
	// validation here
	// -------------------------------------------------
	if ($database_host == '') {
		$focus_field = 'database_host';
...
Usually you can get information about your database on your cPanel / MySql (or database) section. <br /><br />
