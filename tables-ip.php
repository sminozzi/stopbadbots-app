...
?>
         ...
         <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Bad IPs Table <?php echo '('. $result->num_rows.' '; ?>Rows) </h6>
            </div>
            <div class="card-body">
...
while($row = $result->fetch_assoc()) {
        echo '<tr>';
        echo '<td id="'.$row["botip"].'" data-ip="'.$row["botip"].'". data-state="'.$row["botstate"].'" >';
       // echo 'Edit';
...
?>
  ...
  <!-- Edit IP Modal-->
  <div class="modal fade" id="editRecordIP" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit Record</h5>
    ...
    <!-- Add IP Modal-->
    <div class="modal fade" id="addRecordIP" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Add Record</h5>
