...
<div class="card  shadow h-100 py-2">
  ...
  <div class="card-body">
    ...
    <h1 class="h3 mb-4 text-gray-800">Limit Visits</h1>
    <div class="container">
      <b>This page works only in Premium Version.</b> <br />
      We can limit a number of visits, just choose the options below. <br />
      You can also whitelist, look the Whitelist tab. <br />
        ...
        <div class="form-group row">
          <div class="col-xs-3">
            ...
            <select name="rate_limiting" id="rate_limiting" data-reset="red" class="form-control">
              <option value="unlimited" <?php echo ($rate_limiting == "unlimited") ? "selected" : null; ?>>Unlimited</option>
              ...
              <option value="5" <?php echo ($rate_limiting == "5") ? "selected" : null; ?>>10 per minute</option>
              <option value="6" <?php echo ($rate_limiting == "6") ? "selected" : null; ?>>20 per minute</option>
            </select>
          </div>
        </div>
        <br />
        <div class="form-group row">
          <div class="col-xs-3">
            ...
            <select name="rate_limiting_day" id="rate_limiting_day" data-reset="red" class="form-control">
              ...
              <option value="6" <?php echo ($rate_limiting_day == "6") ? "selected" : null; ?>>200 per hour</option>
